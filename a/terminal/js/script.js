...
document.addEventListener('DOMContentLoaded', function () {
        ...
        '/': {
            home: {
                quei: {
                    ...
                    ".bash_aliases": "",
                    desktop: {
                        "about.txt": "<!DOCTYPE html>\n<span color='blue'>Hello, I'm quei</span>\n<span color='red'>I'm a musican</span>\n<span color='green'>I live in Poznan, Poland</span>\n\n\n<span hidden>Pssss... Also try to type 'color enable' and reopen me </span>",
            ...
            etc: {
                "motd": "welcome to quei's terminal! \n\ntype 'help' to see all available commands",
                "skel": {
                    ".bash_history": "",
                    ".bashrc": "",
                    ".bash_aliases": "",
    ...
    closeButton.addEventListener('click', function () {
        document.location.href = "https://quei.me";
    ...
    const commands = [
...

        {
            name: 'cloud',
            root: false,
            description: 'Open the cloud',
            execute: function () {
                var output = document.createElement('div');
                if (settings.currentUser !== 0) {
                    output.textContent = 'Opening the cloud!';
                    window.location.href = 'https://www.icloud.com/iclouddrive/';
...

        {
            name: 'nga',
            root: true,
            description: 'nword tf???',
            execute: function () {
                var output = document.createElement('div');
                if (settings.currentUser !== 0) {
                    output.textContent = 'u nga bruhhhh';
...

        {
            ...
            execute: function () {
                var output = document.createElement('div');
                if (settings.currentUser !== 0) {
                    output.textContent = 'ulixsz sigma';
...

        {
            ...
            execute: function () {
                var output = document.createElement('div');
                if (settings.currentUser !== 0) {
                    output.textContent = 'what-is-next.pl';
                    window.location.href = 'https://www.what-is-next.pl/';
...

        {
            ...
            execute: function () {
                var output = document.createElement('div');
                if (settings.currentUser !== 0) {
                    output.textContent = 'who tf is quei';
                    window.location.href = 'https://www.quei.me/wtf';
...

        {
            ...
            execute: function () {
                var output = document.createElement('div');
                if (settings.currentUser !== 0) {
                    output.textContent = 'opening ig for u!';
                    window.location.href = 'https://www.instagram.com/quei_music/';
...

        {
            ...
            execute: function () {
                var output = document.createElement('div');
                if (settings.currentUser !== 0) {
                    output.textContent = 'opening yt for u!';
                    window.location.href = 'https://www.youtube.com/@quei_music/';
...

        {
            name: 'sc',
            root: false,
            description: 'My SoundCloud',
            execute: function () {
                var output = document.createElement('div');
                if (settings.currentUser !== 0) {
                    output.textContent = 'opening sc for u!';
                    window.location.href = 'https://soundcloud.com/quei_music';
...

        {
            ...
            execute: function () {
                var output = document.createElement('div');
                if (settings.currentUser !== 0) {
                    output.textContent = 'opening spotify for u!';
                    window.location.href = 'https://open.spotify.com/artist/5UuNN4fNOfd46KIq4qhivx?si=7NrEi8GqQlGrkQwc2pZgXQ&nd=1&dlsi=20aefe28efa3436a';
...

        {
            ...
            execute: function () {
                var output = document.createElement('div');
                if (settings.currentUser !== 0) {
                    output.textContent = 'quei.me';
                    window.location.href = 'https://www.quei.me';
...

        {
            ...
            execute: function () {
                var output = document.createElement('div');
                if (settings.currentUser !== 0) {
                    output.textContent = 'hello bro, hope y will have great time here :33';
...

        {
            ...
            execute: function () {
                var output = document.createElement('div');
                if (settings.currentUser !== 0) {
                    output.textContent = 'githubbbb';
                    window.location.href = 'https://github.com/whatisnextpl/safari';
...

        {
            ...
            execute: function () {
                var output = document.createElement('div');
                if (settings.currentUser !== 0) {
                    output.textContent = 'Safariiii <333';
                    window.location.href = 'https://open.spotify.com/album/2WT1DsKLDN3g9nDWeyjHGa?si=39R8dbN7RRiY6fcfidBlnQ';
...

        {
            ...
            execute: function () {
                var output = document.createElement('div');
                if (settings.currentUser !== 0) {
                    output.textContent = 'my discord nickname: @quei_music :33';
